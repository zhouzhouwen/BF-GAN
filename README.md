...
* After downloading, please put all models in ./BF-GAN-models/, and the code will automatically identify the location.

* You can download the BF-GAN models at：
...
You can download the Bubble detection models at：
...
```
2024
BF-GAN: Development of an AI-driven Bubbly Flow Image Generation Model Using Bubbly Generative Adversarial Networks <br>
Wen Zhou1, Shuichiro Miwa1, Yang Liu2, Koji Okamoto1<br>
```
